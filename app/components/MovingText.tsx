...
const MovingText = () => {
  ...
  return (
    <div className="w-full h-screen absolute top-[calc(100vh - 300px)] bg-white text-black">
      <div ref={sliderRef} className="flex items-center relative min-w-[310vw] text-[160px] ">
        ...
        <div ref={secondtextRef} className="flex items-center gap-15 absolute left-490">
          <h1 className="flex">
            New Day ― <Roboto text="        New            Inspo" />
          </h1>
          <div className="w-54 h-34 rounded-full bg-white overflow-hidden">
